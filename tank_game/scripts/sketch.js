...
function preload(){
    switchimage = loadImage("images/reload.png"); 
    settingsimage = loadImage("images/settings.png");
    antitank = loadImage("images/antitank.png");
    machine = loadImage("images/machine.png");
    gatling = loadImage("images/gatling.png");
    hangar = loadImage("images/hangar.png");
    ironingot = loadImage("images/ironingot.webp");
    al = loadImage("images/aluminium.jfif");
    steel = loadImage("images/steelingot.webp");
    titanium = loadImage("images/titanium.png");
    composite = loadImage("images/composite.png");
    chobham = loadImage("images/chobam.png");
    coin = loadImage("images/coin.png");
    medikit = loadImage("images/medikit.png");
    bandage = loadImage("images/bandage.png");
    missile = loadImage("images/missile.png");
    upgrade = loadImage("images/upgrade.png");
    tanktrack = loadImage("images/tanktrack.jfif");
}
